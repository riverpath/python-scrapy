...
stock_id=['sz000651','sz000877','sh601212']
URLS = ["http://api.finance.ifeng.com/akdaily/?code=" + i + "&type=last" for i in stock_id]
...
class MyClass(object):
   ...
   'Accept-Encoding': 'gzip, deflate',}
    ...
    def get(self, url):
        ...
        yield self.http.fetch(request, callback=self.savefile, raise_error=False)
    ...
    def savefile(self, response):
        ...
        try:
            ...
            frame=pd.DataFrame(tt,columns=columns)
...
class Download(object):
    ...
    def data_scrapy(self,urls,pstr):
        self.set_url(urls)
